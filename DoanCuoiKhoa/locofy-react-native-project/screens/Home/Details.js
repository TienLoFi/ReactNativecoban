      ...
      <ScrollView>
        ...
        <View style={styles.contentCenter}>
          ...
          <View style={styles.specRow}>
            ...
            <Text style={styles.specValue}>2018</Text>
          </View>
          <View style={styles.specRow}>
            <Text style={styles.specLabel}>Tình trạng:</Text>
            <Text style={styles.specValue}>Xe đã dùng</Text>
          </View>
          <View style={styles.specRow}>
            <Text style={styles.specLabel}>Số Km đã đi:</Text>
            <Text style={styles.specValue}>64,000 Km</Text>
          </View>
          <View style={styles.specRow}>
            <Text style={styles.specLabel}>Xuất xứ:</Text>
            <Text style={styles.specValue}>Lắp ráp trong nước</Text>
          </View>
          <View style={styles.specRow}>
            <Text style={styles.specLabel}>Kiểu dáng:</Text>
            <Text style={styles.specValue}>SUV</Text>
          </View>
          <View style={styles.specRow}>
            <Text style={styles.specLabel}>Hộp số:</Text>
            <Text style={styles.specValue}>Số tự động</Text>
          </View>
          <View style={styles.specRow}>
          ...
          <View style={styles.specRow}>
            ...
            <Text style={styles.specValue}>Xanh</Text>
          </View>
          <View style={styles.specRow}>
            <Text style={styles.specLabel}>Màu nội thất:</Text>
            <Text style={styles.specValue}>Đen</Text>
          </View>
          <View style={styles.specRow}>
            <Text style={styles.specLabel}>Số chỗ ngồi:</Text>
            <Text style={styles.specValue}>5 chỗ</Text>
          </View>
          <View style={styles.specRow}>
            <Text style={styles.specLabel}>Số cửa:</Text>
            <Text style={styles.specValue}>5 cửa</Text>
          </View>
          <View style={styles.specRow}>
            <Text style={styles.specLabel}>Dẫn động:</Text>
            <Text style={styles.specValue}>FWD - Dẫn động cầu trước</Text>
          </View>
        </View>
      </ScrollView>
