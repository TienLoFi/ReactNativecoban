    ...
    <View style={styles.container}>
            ...
            <View key={data.item.key}>
              <View style={styles.imageContainer}>
                <Image
                  ...
                  resizeMode="contain"
                />
                <View style={{ flexDirection: "column", marginLeft: "3%", marginTop: "3%" }}>
                  <Text style={{ fontWeight: "bold", fontSize: 18 }}>{data.item.title}</Text>
                 
                  <Text style={{ marginLeft: "30%", marginTop: "5%", fontWeight: "bold", fontSize: 18 }}>
                    BYN {data.item.price}
                  </Text>
      ...
      <View style={styles.bottom}>
        <View style={styles.price}>
          ...
          <Text style={styles.byn900}>BYN {formattedPrice(totalSum)}</Text>
        </View>
