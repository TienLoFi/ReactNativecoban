...
import { StyleSheet, Text, View, TouchableHighlight ,SafeAreaView,StatusBar,TouchableOpacity,Dimensions} from "react-native";
...
const PayAndOrder = ({ navigation }) => {
 ...
 <View style={[styles.bag, styles.bagLayout]}>
     <View style={{ flexDirection: 'row', alignItems: 'center' }}>
      ...
      <Text style={styles.text}>809.000đ</Text>
    ...
    Số Tiền Phải Trả
      ...
      <Text style={[styles.raghuK44, styles.raghuK44Typo]}>{`56 Tăng Nhơn Phú,
Phường Tăng Nhơn Phú B,
Thành Phố Thủ Đức,
Ngọc Tiến - 0369864072`}</Text>
      <Image
      ...
      <Text style={[styles.selinaK213, styles.selinaK213Position]}>{`139/12/9 Đường 14,
Phường Phước Bình,
Thành Phố Thủ Đức,
Ngọc Tiến -0369864072`}</Text>
